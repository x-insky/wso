...
<form name = "dodaj_auto" enctype="multipart/form-data" action = "./index.php" method = "post" onsubmit="return sprawdz_formularz_dodaj_auto(this)" >
 ...
 <tr>
  ...
  <select name="marka" class="formularz_dodaj4"> 
   <option style="color: red; "value="0"> Wybierz markę pojazdu...</option>
<?php  
...
?>
 ...
 <tr>
  ...
  <td>
    ...
    <!--    <option style="color: red;" value="0"> Wybierz kategorię pojazdu... </option>  -->
 ...
 <tr>
  ...
  <td>
    ...
    <!--    <optgroup label="Wybierz kategorię pojazdu">  -->
     <option style="color: red;" value="0"> Wybierz kategorię pojazdu... </option>
<?php  
...
?>
 ...
 <tr>
  <td class="tab_nazwa_kolumny2">Pojemno¶ć [cm^3]</td>
 ...
 <tr>
  ...
  <td>
   <select name="liczba_drzwi" class="formularz_dodaj4"> 
    <option style="color: red; "value="0"> Wybierz ilo¶ć drzwi...</option>
<?php  
...
?>
 ...
 <tr>
  <td class="tab_nazwa_kolumny2">Zdjęcia</td>
  <td>
...
<br />
<p class="akapit_wezszy">Dodawanie zdjęć do pojazdów <b>działa</b>!</p>
</form>