...
<form name = "dodaj_tresc" action = "./index.php" method = "post" >
 ...
 <tr>
  ...
  <td class="tab_dane_kolumny"><label><input type="radio" name="rodzaj_tresci_dodaj" value="aktualnosci" checked="checked" />Aktualno¶ci</label>&nbsp;&nbsp;
 ...
 ma obowi±zywaæ od razu <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(ma znaczenie tylko dla promocji)</label>
  <td>
 </tr>
 <tr>
  <td>&nbsp;</td>
