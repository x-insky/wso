...
<tr>
 <td class="tab_nazwa_kolumny">Zablokowani u¿ytkownicy</td> 
 <td class="tab_dane_kolumny"><label><input type="checkbox" name="wyswietl_zablokow" value="tylko_zablokowani" /> wy¶wietl <b>tylko</b> zablokowanych u¿ytkowników serwisu</label></td>
 <td>&nbsp;</td>
</tr>
<tr>
 <td class="tab_nazwa_kolumny">Sortuj wg</td> 
 <td class="tab_dane_kolumny"><label><input type="radio" name="rodzaj_sortowania" value="rola_nazwisko" checked="checked" /> rola u¿ytkownika, nazwisko, imiê</label><br />
...
<tr>
 <td><input type = "submit" value = "Wy¶wietl u¿ytkowników" class="przycisk1" />&nbsp;</td>
 <td></td>
 <td>&nbsp;</td>
</tr>
</table>
