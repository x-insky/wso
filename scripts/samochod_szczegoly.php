...
<?php
 ...
 //przypisanie w mairę prostych wyników
...
// + wyszukiwanie adresó zdjęc pojazdu z bazy
...
?>
 ...
 <tr>
  <td class="tab_nazwa_kolumny2">Pojemność [cm^3]</td>
  <td class="tab_dane_kolumny">
<?php  
echo("$pojemnosc");
?>  
...
?>
 ...
 <tr>
  <td class="tab_nazwa_kolumny2">Wyposażenie</td>
  <td class="tab_dane_kolumny">
<?php  
echo("$wyposazenie"); 
?>  
...
<?php
 ...
 $max_x = 101;
  ...
  {
  $parametry = getimagesize( $adres[$i] );  //sprawdzenie szerokości wczytanego zdjęcia
  $szer = $parametry['0'];
  $wys = $parametry['1'];
  ...
  echo('<td class="tab_dane_kolumny2">');     //promorcjonalne zmniejszenie oryginału
...
echo('<tr>'); 
 ...
 {
 echo('<td>');
 echo("<h5>Zalogowani użytkownicy mogą zarezerwować auto na wybrany okres</h5>");
...
//       onsubmit="return pokaz()" >');
  ...
  echo('<h4>Data początkowa:</h4>');
  echo('<p class="akapit_wezszy">&nbsp;&nbsp;&nbsp; dzień &nbsp;-&nbsp;&nbsp; miesiąc &nbsp;&nbsp;-&nbsp;&nbsp; rok &nbsp;&nbsp;</p>');
  echo('</td>');
  echo('<td class="komorka_prawa"> <h4>Data końcowa:</h4>');
  echo('<p class="akapit_prawy_wezszy"> dzień &nbsp;-&nbsp;&nbsp; miesiąc &nbsp;&nbsp;-&nbsp;&nbsp; rok&nbsp;&nbsp;&nbsp;</p>');
  echo('</td>');
 echo('</tr>');
...
//rok koncowy rezerwacji   
 ...
 echo("<input type=\"submit\" name=\"rezerwuj_1_auto\" value=\"Sprawdź termin\" class=\"przycisk1\" />");
